...
| **Total files** | 827 |
| Extra module/feature examples (every language) | 1773 |
...
| Ada | programming | template | ci_executed | `gnatmake weda.adb -o /tmp/hello_ada && /tmp/hello_ada` |
...
| AMPL | programming | template | not_ci_executed | `ampl lorysyda.ampl` |
...
| ASL | programming | hand-written | source | `source (toolchain required)` |
...
| Asymptote | programming | template | not_ci_executed | `asy liqi.asy` |
| ATS | programming | template | not_ci_executed | `patscc defedaxu.dats` |
...
| Awk | programming | template | ci_executed | `awk -f zowe.awk /dev/null` |
...
| Batchfile | programming | template | not_ci_executed | `cmd vaqeco.bat` |
...
| C | programming | template | ci_executed | `gcc myceme.c -o /tmp/hello_c && /tmp/hello_c` |
| C-ObjDump | data | document | source | `valid data document` |
| C# | programming | template | ci_executed | `dotnet run` |
| C++ | programming | template | ci_executed | `g++ ciwyxely.cpp -o /tmp/hello_cpp && /tmp/hello_cpp` |
| C2hs Haskell | programming | template | not_ci_executed | `-` |
| C3 | programming | template | not_ci_executed | `c3c senaxe.c3` |
...
| Ceylon | programming | template | not_ci_executed | `ceylon roduze.ceylon` |
| Chapel | programming | template | not_ci_executed | `chpl sygo.chpl` |
...
| Clean | programming | template | not_ci_executed | `clm nulu.icl` |
...
| Clue | programming | hand-written | source | `source (toolchain required)` |
...
| CoffeeScript | programming | template | not_ci_executed | `coffee pyqo.coffee` |
...
| Common Lisp | programming | template | ci_executed | `clisp doga.lisp` |
...
| Csound | programming | template | not_ci_executed | `csound susevequ.orc` |
...
| Cython | programming | template | not_ci_executed | `cython tilyvohi.pyx` |
...
| Dafny | programming | template | not_ci_executed | `dafny nesuja.dfy` |
| Darcs Patch | data | document | source | `valid data document` |
| Dart | programming | template | not_ci_executed | `dart hegi.dart` |
...
| DenizenScript | programming | hand-written | source | `source (toolchain required)` |
...
| Dockerfile | programming | template | not_ci_executed | `docker cisyjivi.dockerfile` |
...
| Elixir | programming | template | ci_executed | `elixir gevuqyfi.ex` |
| Elm | programming | template | not_ci_executed | `-` |
| Elvish | programming | template | not_ci_executed | `elvish xyhicu.elv` |
| Elvish Transcript | programming | hand-written | source | `source (toolchain required)` |
| Emacs Lisp | programming | template | not_ci_executed | `emacs --batch doko.el` |
...
| Erlang | programming | template | ci_executed | `escript fuhace.erl` |
| Euphoria | programming | hello-world | source | `source (toolchain required)` |
| F* | programming | template | not_ci_executed | `-` |
| F# | programming | template | ci_executed | `dotnet fsi tiba.fs` |
| Factor | programming | template | not_ci_executed | `factor kyci.factor` |
...
| Fennel | programming | template | not_ci_executed | `fennel ruzosoke.fnl` |
...
| fish | programming | template | not_ci_executed | `fish jyla.fish` |
...
| Forth | programming | template | ci_executed | `gforth hamozi.fth -e bye` |
| Fortran | programming | template | ci_executed | `gfortran nyke.f90 -o /tmp/hello_f90 && /tmp/hello_f90` |
...
| Futhark | programming | template | not_ci_executed | `futhark motyra.fut` |
...
| GDScript | programming | template | not_ci_executed | `godot tubymu.gd` |
...
| Genero 4gl | programming | hand-written | source | `source (toolchain required)` |
| Genero per | markup | document | source | `valid markup document` |
| Genie | programming | hello-world | source | `source (toolchain required)` |
| Genshi | programming | hand-written | source | `source (toolchain required)` |
...
| Glimmer JS | programming | hand-written | source | `source (toolchain required)` |
| Glimmer TS | programming | hand-written | source | `source (toolchain required)` |
| GLSL | programming | hand-written | source | `source (toolchain required)` |
| Glyph | programming | hand-written | source | `source (toolchain required)` |
...
| Go | programming | template | ci_executed | `go run mosugafo.go` |
...
| Grace | programming | hand-written | source | `source (toolchain required)` |
| Gradle | data | document | source | `valid data document` |
| Gradle Kotlin DSL | data | document | source | `valid data document` |
| Grammatical Framework | programming | hand-written | source | `source (toolchain required)` |
...
| Groovy | programming | template | ci_executed | `groovy cudyme.groovy` |
...
| Haskell | programming | template | ci_executed | `runghc dydajahy.hs` |
...
| hoon | programming | hand-written | source | `source (toolchain required)` |
...
| Hy | programming | template | not_ci_executed | `hy jusufy.hy` |
...
| Idris | programming | template | not_ci_executed | `idris wanaxovi.idr` |
...
| ImHex Pattern Language | programming | hand-written | source | `source (toolchain required)` |
...
| Io | programming | template | not_ci_executed | `io quju.io` |
...
| J | programming | template | not_ci_executed | `jconsole laza.ijs` |
...
| Janet | programming | template | not_ci_executed | `janet vuqevano.janet` |
...
| Java | programming | template | ci_executed | `java naja.java` |
...
| JavaScript | programming | template | ci_executed | `node bary.js` |
...
| JetBrains MPS | programming | hand-written | source | `source (toolchain required)` |
...
| Julia | programming | template | ci_executed | `julia fify.jl` |
...
| KFramework | programming | hand-written | source | `source (toolchain required)` |
...
| KRL | programming | hand-written | source | `source (toolchain required)` |
| Kusto | data | document | source | `valid data document` |
| kvlang | markup | document | source | `valid markup document` |
| LabVIEW | programming | hand-written | source | `source (toolchain required)` |
| Lambdapi | programming | hand-written | source | `source (toolchain required)` |
| Langium | programming | hand-written | source | `source (toolchain required)` |
...
| Leo | programming | hand-written | source | `source (toolchain required)` |
...
| LigoLANG | programming | hand-written | source | `source (toolchain required)` |
...
| Liquidsoap | programming | hand-written | source | `source (toolchain required)` |
| Literate Agda | programming | hand-written | source | `source (toolchain required)` |
...
| LiveScript | programming | template | not_ci_executed | `livescript niwakydu.ls` |
...
| Lua | programming | template | ci_executed | `lua5.4 hapa.lua` |
...
| MATLAB | programming | template | not_ci_executed | `octave beto.m` |
...
| Mercury | programming | template | not_ci_executed | `mmc nebapuho.m` |
...
| MeTTa | programming | hand-written | source | `source (toolchain required)` |
...
| MiniD | programming | hand-written | source | `source (toolchain required)` |
...
| MLIR | programming | hand-written | source | `source (toolchain required)` |
...
| Module Management System | programming | hand-written | source | `source (toolchain required)` |
...
| Moocode | programming | hand-written | source | `source (toolchain required)` |
...
| Motorola 68K Assembly | programming | hand-written | source | `source (toolchain required)` |
...
| NetLogo | programming | template | not_ci_executed | `netlogo siveze.nlogo` |
| NewLisp | programming | template | not_ci_executed | `newlisp vamupaje.nl` |
| Nextflow | programming | template | not_ci_executed | `nextflow syroqexo.nf` |
...
| NMODL | programming | hand-written | source | `source (toolchain required)` |
| Noir | programming | hand-written | source | `source (toolchain required)` |
...
| OCaml | programming | template | ci_executed | `ocaml jywubewu.ml` |
| Odin | programming | template | not_ci_executed | `odin syrona.odin` |
...
| Opal | programming | hand-written | source | `source (toolchain required)` |
...
| OpenSCAD | programming | template | not_ci_executed | `openscad boly.scad` |
...
| OverPy | programming | hand-written | source | `source (toolchain required)` |
...
| Pan | programming | hand-written | source | `source (toolchain required)` |
...
| Pascal | programming | template | ci_executed | `fpc fuzofu.pas -o/tmp/hello_pas >/dev/null && /tmp/hello_pas` |
...
| Perl | programming | template | ci_executed | `perl qyqezo.pl` |
| PHP | programming | template | ci_executed | `php cybe.php` |
...
| Pony | programming | template | not_ci_executed | `pony pibogosu.pony` |
...
| PowerShell | programming | template | not_ci_executed | `pwsh qyqokopy.ps1` |
...
| Prolog | programming | template | ci_executed | `swipl -q -g "main" -t halt -f lona.pro` |
...
| Puppet | programming | template | not_ci_executed | `puppet zuxozazy.pp` |
| Pure Data | data | hello-world | source | `source (toolchain required)` |
| PureBasic | programming | template | not_ci_executed | `-` |
| PureScript | programming | template | not_ci_executed | `purs duso.purs` |
| Pyret | programming | hello-world | source | `source (toolchain required)` |
| Python | programming | template | ci_executed | `python3 buneje.py` |
...
| Qt Script | programming | hand-written | source | `source (toolchain required)` |
...
| R | programming | template | ci_executed | `Rscript xofo.R` |
| Racket | programming | template | ci_executed | `racket xedulawi.rkt` |
...
| RAScript | programming | hand-written | source | `source (toolchain required)` |
...
| Red | programming | template | not_ci_executed | `red pecepixu.red` |
...
| REXX | programming | template | not_ci_executed | `rexx tiko.rexx` |
...
| Ring | programming | template | not_ci_executed | `ring jehanydu.ring` |
...
| Rouge | programming | hand-written | source | `source (toolchain required)` |
...
| Ruby | programming | template | ci_executed | `ruby sipaxodi.rb` |
| RUNOFF | markup | document | source | `valid markup document` |
| Rust | programming | template | ci_executed | `rustc mexuquhu.rs -o /tmp/hello_rs && /tmp/hello_rs` |
...
| SAS | programming | template | not_ci_executed | `sas xori.sas` |
...
| Scheme | programming | template | ci_executed | `guile nityva.scm` |
| Scilab | programming | template | not_ci_executed | `scilab zoroqify.sci` |
| SCSS | markup | hello-world | source | `source (toolchain required)` |
| sed | programming | template | ci_executed | `echo foo | sed -f loxali.sed` |
...
| Shell | programming | template | ci_executed | `bash byle.sh` |
...
| Slang | programming | hand-written | source | `source (toolchain required)` |
| Slash | programming | hand-written | source | `source (toolchain required)` |
...
| Smalltalk | programming | template | not_ci_executed | `gst konasu.st` |
...
| Snakemake | programming | template | not_ci_executed | `snakemake taluryse.smk` |
| Solidity | programming | template | not_ci_executed | `solc povuseta.sol` |
...
| SQL | data | template | ci_executed | `sqlite3 :memory: < zamoci.sql` |
| SQLPL | programming | hand-written | source | `source (toolchain required)` |
| Squirrel | programming | template | not_ci_executed | `squirrel vype.nut` |
...
| Stata | programming | template | not_ci_executed | `stata pifymanu.do` |
...
| SystemVerilog | programming | template | not_ci_executed | `iverilog zeliwo.sv` |
...
| Tcl | programming | template | ci_executed | `tclsh mudenofa.tcl` |
...
| Terra | programming | template | not_ci_executed | `terra nutisini.t` |
...
| TL-Verilog | programming | hand-written | source | `source (toolchain required)` |
...
| Tolk | programming | hand-written | source | `source (toolchain required)` |
...
| TypeScript | programming | template | ci_executed | `npx --yes tsc poreze.ts && node poreze.js` |
...
| Unix Assembly | programming | hand-written | source | `source (toolchain required)` |
| Uno | programming | hand-written | source | `source (toolchain required)` |
...
| Vala | programming | template | ci_executed | `valac lycamuma.vala -o /tmp/hello_vala && /tmp/hello_vala` |
...
| Verse | programming | hand-written | source | `source (toolchain required)` |
...
| Visual Basic .NET | programming | template | ci_executed | `dotnet run` |
| Visual Basic 6.0 | programming | hand-written | source | `source (toolchain required)` |
| Volt | programming | hand-written | source | `source (toolchain required)` |
...
| Witcher Script | programming | hand-written | source | `source (toolchain required)` |
...
| Xojo | programming | hand-written | source | `source (toolchain required)` |
...
| XS | programming | hand-written | source | `source (toolchain required)` |
...
| YARA | programming | template | not_ci_executed | `yara sote.yar` |
...
| Zeek | programming | template | not_ci_executed | `zeek dycaha.zeek` |
...
| ZIL | programming | hand-written | source | `source (toolchain required)` |
