...
A `publish.yml` workflow creates a fresh GitHub Release (with auto-generated release notes) on **every push** to main, and a release was created immediately at repo creation (v0.2.0).
